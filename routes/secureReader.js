...
router.get('/:bookId', async (req, res) => {
    try {
        ...
        if (!order.content_url) {
            ...
            // Return a simple PDF message instead of error
...
%%EOF`;
        ...
        // Set headers to allow iframe embedding and prevent download dialog
        res.set({
            'Content-Type': 'application/pdf',
            'Content-Disposition': 'inline; filename="protected-book.pdf"',
            'Access-Control-Allow-Origin': '*', // Allow cross-origin for iframe
