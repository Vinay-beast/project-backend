...
const compression = require('compression'); // gzip compression for faster responses
...
// ----------------------------------------
app.use(compression()); // compress all responses (gzip) - reduces payload size by up to 80%
app.use(helmet({
